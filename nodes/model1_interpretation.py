...
# These mirror standard hematology triage guidelines.
_SEVERITY_THRESHOLDS = {
    # (mild_pct, moderate_pct, severe_pct)
    "default": (10, 25, 50),
    # Parameters where smaller deviations are already clinically significant
    "Hemoglobin":         (10, 20, 35),
    "Platelets":          (15, 35, 60),
...
# Parameters flagged as immediately critical regardless of severity
_CRITICAL_LOW_PARAMS = {
    "Hemoglobin": 7.0,        # g/dL — transfusion threshold
    "Platelet Count": 50000,  # /cumm — bleeding risk
    "Total WBC count": 2000,  # /cumm — severe leukopenia
}

_CRITICAL_HIGH_PARAMS = {
    "Total WBC count": 30000,  # /cumm — leukemoid reaction
    "Platelet Count": 1000000, # /cumm — thrombocytosis
}
